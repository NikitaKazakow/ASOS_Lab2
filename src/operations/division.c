...
int main(int argc, char *argv []) {
    ...
    while(true) {
        ...
        printf("Процесс деления: значение %lf прочитано из очереди\n", a);
        ...
        {
            printf("Процесс деления: Ошибка отправки значения: %lf\n", result);
            return -1;
        }
        else
        {
            printf("Процесс деления: Результат: %lf / %lf = %lf\n", a, b, result);
